...
(function () {
  ...
  function show(targets) {
    ...
    box.innerHTML =
      ...
      "color:var(--muted,#8a8f9c);border-radius:6px;padding:6px 14px;font-size:0.8rem;cursor:pointer;margin-right:8px;'>後で</button>" +
      "<button id='quest-prompt-save' style='background:transparent;border:1px solid var(--accent,#f0c674);" +
      "color:var(--accent,#f0c674);border-radius:6px;padding:6px 14px;font-size:0.8rem;cursor:pointer;'>登録する</button>" +
      "</div>";
